 ...
 * @param prevalenceBias A number specifying how biased the algorithm should be towards colors that are more prevalent
 * than others. 0 indicates no bias; of the resolved colors detected for the given box, all have an equal chance of being
 ...
 */
export function assignColorToBox(samplesForBox: RgbColor[], resolvedColors: RgbColor[], prevalenceBias: number) {
